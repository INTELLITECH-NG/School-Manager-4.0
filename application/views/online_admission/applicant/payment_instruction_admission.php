				...
				<div class="row">
					<div class="col-xs-12 padded">
						<ul class="how_it_works background_white border_gray text-justify">
							...
							<li class="wow fadeInDown animated animated" style="visibility: visible; animation-name: fadeInDown;">	<?php echo $this->lang->line('enter');?> <b><?php echo $slip_info[0]['total_amount']; ?></b> <?php echo $this->lang->line('in amount.');?></li>

							<li class="wow fadeInDown animated animated" style="visibility: visible; animation-name: fadeInDown;">	<?php echo $this->lang->line('enter');?> <b><?php echo $this->session->userdata("app_id"); ?></b> <?php echo $this->lang->line('as reference');?></li>
					...
					<div class="col-xs-12">			
						<ul class="how_it_works background_white border_gray text-justify">		
							...
							<li class="wow fadeInDown animated animated" style="visibility: visible; animation-name: fadeInDown;">	<?php echo $this->lang('enter');?> <b><?php echo $this->session->userdata("app_id"); ?></b> <?php echo $this->lang->line('as Bill No.');?></li>
							<li class="wow fadeInDown animated animated" style="visibility: visible; animation-name: fadeInDown;">	<?php echo $this->lang('enter');?> <b><?php echo $slip_info[0]['total_amount']; ?></b> <?php echo $this->lang->line('in amount.');?></li>
