	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 col-md-12 col-lg-6 col-lg-offset-3">
				...
				<form class="well" method="POST" action="<?php echo site_url('applicant/reset_password_action'); ?>">
					<div class="form-group">
						<label for="old_password"><?php echo $this->lang->line('old password');?></label>
						<div>
							<input type="password" class="form-control" id="old_password" name="old_password" placeholder=<?php echo $this->lang->line("old password");?> >
					...
					<div class="form-group">
						...
						<div>
							<input type="password" class="form-control" id="new_password" name="new_password" placeholder=<?php echo $this->lang->line("new password");?> >
					...
					<div class="form-group">
						...
						<div>
							<input type="password" class="form-control" id="confirm_new_password" name="confirm_new_password" placeholder=<?php echo $this->lang->line("confirm new password");?> >
