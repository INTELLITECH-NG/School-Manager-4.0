   ...
   <section class="content">
     <div class="box box-info custom_box">
       <div class="box-header">
         <h3 class="box-title"><i class="fa fa-pencil"></i><?php echo $this->lang->line('edit pay slip'); ?> </h3>
       </div><!-- /.box-header -->
       <!-- form start -->
         ...
         <div class="box-body">
           <div class="form-group">
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
               <input name="hidden_id" value="<?php echo $xdata_slip[0]['id'];?>" type="hidden">
               <input name="name"value="<?php echo $xdata_slip[0]['slip_name'];?>"  class="form-control" type="text">
           ...
           <div class="form-group">
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
               <?php 
                ...
                echo form_dropdown('class_id',$class_info,$xdata_slip[0]['class_id'],'class="form-control" id="class_id"'); 
               ?>
           ...
           <div class="form-group">
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
               <?php 
                $dept_info=array(""=>"",$xdata_slip[0]['dept_id']=>$xdata_slip[0]['dept_name']);
                echo form_dropdown('dept_id',$dept_info,$xdata_slip[0]['dept_id'],'class="form-control" id="dept_id"'); 
               ?>
           ...
           <div class="form-group">
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
               <?php 
                ...
                echo form_dropdown('session_id',$session_info,$xdata_slip[0]['financial_year_id'],'class="form-control" id="session_id"'); 
               ?>
           ...
           <div class="form-group">
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
               <?php 
                $slip_types['']='';
                echo form_dropdown('slip_type',$slip_types,$xdata_slip[0]['slip_type'],'class="form-control" id="slip_type"'); 
               ?>
           ...
           <div class="form-group">             
             <div class="col-sm-12">
               <h2 class='orange text-center'><?php echo $this->lang->line('grand total'); ?> : <span id="grand_total"><?php echo $xdata_slip[0]['total_amount']; ?></span></h2>
               <hr>
             </div>
           </div>
                 ...
                 {  
                    ...
                    echo "<div style='padding:15px; background:#fefefe; border:1px solid #ccc;'>";
                      ...
                      for($i=0;$i<count($heads_id_array);$i++)
                      {
                         ...
                         echo "<input class='form-control head_amount' placeholder='Amount' style='display:inline' type='text' name='".$input_name."' value='".$input_value."'/><br/>";
           ...
           <div class="box-footer">
            <div class="form-group">
             <div class="col-sm-12 text-center">
               ...
               <?php } ?>      
               <input type="button" class="btn btn-default btn-lg" value=<?php echo $this->lang->line("cancel");?> onclick='goBack("admin/pay_slips",1)'/>
             </div>
           </div>
         </div><!-- /.box-footer -->         
         </div><!-- /.box-info -->       
