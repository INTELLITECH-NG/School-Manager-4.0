              ...
              if (isset($info[$i]['is_returned'])  && $info[$i]['is_returned'] == "0")
                {
                  ...
                  $temp_url = site_url('admin_library/update_circulation')."/".$first_par."/".$second_par;
...
$j("document").ready(function(){
  ...
  $(document.body).on('click','.return',function(){
    ...
    $.ajax({
      type:'POST',
      url: base_url+"admin_library/update_circulation",
      data:{id:id},
  ...
  $("#new_issue_submit").click(function(){
    ...
    $.ajax({
      type:'POST',
      url: base_url+"admin_library/new_issue_action",
