<section class="content-header">
	<section class="content">
		<div class="box box-info custom_box">
			...
			<!-- form start -->
			<form class="form-horizontal" action="<?php echo site_url().'admin_library/update_book_action/'.$info['id'];?>" enctype="multipart/form-data" method="POST">
				<div class="box-body">
		             ...
		             <div class="box-footer">
		             	<div class="form-group">
		             		<div class="col-sm-12 text-center">
		             			...
		             			<input type="button" class="btn btn-default btn-lg" value="<?php echo $this->lang->line("cancel"); ?>" onclick='goBack("admin_library/book_list",1)'/>  
		             		</div>
		             	</div>
		             </div><!-- /.box-footer -->         
		         </div><!-- /.box-info -->       
