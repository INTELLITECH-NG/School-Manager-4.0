<section class="content-header">
	<section class="content">
		<div class="box box-info custom_box">
			...
			<!-- form start -->
			<form class="form-horizontal" action="<?php echo site_url().'admin_library/add_book_action';?>" enctype="multipart/form-data" method="POST">
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-md-6 col-lg-6">
							<?php	$all_physical_form['']=$this->lang->line("physical form");
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-md-6 col-lg-6">
							<?php	$size_all['']=$this->lang->line("size");
				...
				<div class="box-footer">
					<div class="form-group">
						<div class="col-sm-12 text-center">
							...
							<input type="button" class="btn btn-default btn-lg" value="<?php echo $this->lang->line('cancel');?>" onclick='goBack("admin_library/book_list")'/>  
						</div>
					</div>
				</div><!-- /.box-footer -->         
			</div><!-- /.box-info -->       
