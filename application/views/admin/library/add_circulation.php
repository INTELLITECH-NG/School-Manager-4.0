...
<div class="row">
  ...
  <div class="col-xs-12  col-sm-12 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3" style="margin-top:0px;background-color:#EEE;padding:10px;">
    ...
    <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
      <form class="form" role="form" action="<?php echo site_url().'admin_library/add_circulation_action';?>"  method = "post" style="padding-left:15px;">
...
<script type="text/javascript">
  $('#member_id').keyup(function(){
    ...
    var url = "<?php echo site_url('admin_library/get_suggestion_for_member'); ?>";
    $.ajax
    ({
       type:'POST',
...
<script type="text/javascript">
  $('#book_id').keyup(function(){
    ...
    var url = "<?php echo site_url('admin_library/get_suggestion_for_book'); ?>";
    $.ajax
    ({
       type:'POST',
  ...
  $(document.body).on('click','.book_name',function(){
    ...
    $.ajax({
      type:'POST',
      url: base_url+"admin_library/new_issue_check",
...
<div class="row">
  <div class="col-md-12">
    <div>
      ...
      {
        if(isset($row))
          $this->load->view('admin/library/add_circulation_result');
      }  
      if(isset($member_exist) && empty($member_exist)) 
