...
<a class="btn btn-warning"  title="<?php echo $this->lang->line("add"); ?> - <?php echo $this->lang->line("book"); ?>" href="<?php echo site_url('admin_library/add_book');?>">
...
<a class="btn btn-primary pull-right" id="import_book_btn"  title="Import" style = 'margin-right:10px'>
    <i class="fa fa-upload"></i> <?php echo $this->lang->line('import book - csv');?>
</a>
