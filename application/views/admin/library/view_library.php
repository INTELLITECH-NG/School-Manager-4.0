...
<section class="content-header">
  <h1> <?php echo $this->lang->line('library');?> </h1>
  ...
  <div class="row">
    <div class="col-xs-12">
        <div class="grid_container" style="width:100%; height:700px;">
            ...
            url="<?php echo base_url()."admin_library/book_list_data"; ?>" 
       ...
       <div id="tb" style="padding:3px">
            ...
            <?php $this->load->view('admin/library/submenu_book'); ?> 
...
<script>       
    ...
    {               
        var details_url=base_url+'admin_library/view_details/'+row.id;        
        var edit_url=base_url+'admin_library/update_book/'+row.id;
        var delete_url=base_url+'admin_library/delete_book_action/'+row.id;
    ...
    $('#barcode').click(function(){
        ...
        var url = "<?php echo site_url('admin_library/barcode_generate');?>";
...
//Section for upload CSV.*********************************
    ...
    $(document.body).on('click','#pull_data',function(){
      ...
      if(fileval == '')
        ...
        $.ajax({
            url: site_url+'admin_library/import_book_action_ajax',
            type: 'POST',
            data: queryString,
            async: false,
            cache: false,
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 id="new_search_details_title" class="modal-title"><i class="fa fa-cloud-upload"></i> <?php echo $this->lang->line('import book from csv');?></h4>
            </div><br/>
            ...
            <div class="modal-body">
                ...
                <br/>
                <br/>
                <br/><span ><a target="_BLANK" class="btn btn-sm btn-primary" href="<?php echo base_url("assets/sample/book_import_sample.csv"); ?>"><i class="fa fa-cloud-download"></i> <?php echo $this->lang->line('download sample csv');?></a></span> 
                <?php echo $this->lang->line('(Open with text editor to view original formatting)');?>
