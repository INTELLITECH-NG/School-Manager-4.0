  ...
  <div class="box box-info custom_box">   
      <div class="box-header">
        <h3 class="box-title">
          ...
          <?php echo $this->lang->line('day wise report');?>
        </h3>
      </div>

      <div class="box-body">
           <form class="form-inline" role="form" method="POST" action="<?php echo site_url()."admin_account/day_wise"; ?>">
           ...
           <div class="text-right"><a class="btn btn-warning"  title="Download" href="<?php echo site_url('admin_account/day_wise_download');?>">
