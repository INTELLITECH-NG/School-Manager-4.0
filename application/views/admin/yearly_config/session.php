<section class="content">
  <div class="box box-info custom_box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-binoculars"></i> <?php echo $this->lang->line('session data');?></h3>
    </div><!-- /.box-header -->

    <form class="form-horizontal" action="<?php echo base_url('yearly_config/session_action'); ?>" method="POST">
        <div class="box-body">
          <?php 
         ...
         <?php if(isset($error) && !empty($error)) echo "<div class='alert alert-danger text-center'>".$error."</div>";?>
          <div class="col-xs-12">
            ...
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <?php 
                  $form['']=$this->lang->line('Copy from session');                      
              ...
              <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <?php 
                  $to['']=$this->lang->line('Copy to session');                      
