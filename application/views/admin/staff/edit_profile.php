   ...
   <section class="content">
     <div class="box box-info custom_box">
       <div class="box-header">
         <h3 class="box-title"><i class="fa fa-plus-circle"></i> <?php echo $this->lang->line('update staff');?></h3>
       </div><!-- /.box-header -->
       <!-- form start -->
        
         <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url().'admin_staff/edit_profile_action';?>" method="POST" >
          <div class="box-body">       

           <div class="form-group" style="display:none" >          
             <div class="col-sm-9 col-md-6 col-lg-6">
               <input  id ="staff_id" class="form-control" value="<?php echo $id;?>" name="staff_id" type="text"  >
               <span class="red"><?php echo form_error('staff_id'); ?></span>
             </div>
           </div>
           ...
           <div class="form-group">
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
               <input  id ="name" class="form-control" value="<?php echo $staff_info['staff_name'];?>" name="name" type="text"  >
           ...
           <div class="form-group">
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
               <input  id="fathers_name"  class="form-control" type="text" value="<?php echo $staff_info['father_name'];?>"   name="fathers_name">
           ...
           <div class="form-group">
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
               <input  id="national_id" name="national_id" class="form-control" value="<?php echo $staff_info['national_id'];?>"  type="text"  >
           ...
           <div class="form-group">
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
               <input id="dp" name="dob" class="form-control" type="text"  value="<?php echo date('d-m-Y',strtotime($staff_info['date_of_birth']));?>" >
           ...
           <div class="form-group">
             ...
             <?php 
              ...
              echo form_dropdown('religion',$religion,$staff_info['religion'],'class="form-control" id="religion"');  
             ?>               
           ...
           <div class="form-group">
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
            <label class="radio-inline"><input type="radio" name="gender" value ="Male" <?php if($staff_info['gender']=='Male') echo "checked";?>>Male</label>
            <label class="radio-inline"><input type="radio" name="gender" value ="Female"  <?php if($staff_info['gender']=='Female') echo "checked";?>>Female</label>
            <span class="red"><?php echo form_error('gender'); ?></span>
             </div>
           </div>

          <!--  Designation is the Post name of the Staff: Sweeper, Night Guard, Clerks etc. -->
           <div class="form-group">
             <label class="col-sm-3 control-label" ><?php echo $this->lang->line('designation');?> *</label>
             <div class="col-sm-9 col-md-6 col-lg-6">
             <?php 
             $academic_rank['']=$this->lang->line("rank");
             echo form_dropdown('rank',$academic_rank,$staff_info['rank_id'],'class="form-control" id="rank"');  
             ?>             
             <span class="red"><?php echo form_error('rank'); ?></span>                          
             </div>
           </div>

           <!-- Rank is the Administrative Status of a Staff: 1st class, 2nd class, 3rd class etc. -->
          <!--  <div class="form-group">
             <label class="col-sm-3 control-label"> Rank *</label>
             <div class="col-sm-9 col-md-6 col-lg-6">
             <?php 
             $administrative_rank['']=$this->lang->line("job class");
             echo form_dropdown('administrative_rank',$administrative_rank,$staff_info['job_class_id'],'class="form-control" id="administrative_rank"');  
             ?>              
           ...
           <div class="form-group">
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
              <textarea class="form-control"  id="address"  name="address"> <?php echo $staff_info['address']; ?></textarea>
          ...
          <!--  <div class="form-group">
             ...
             echo form_dropdown('home_district',$district,$staff_info['home_district'],'class="form-control" id="home_district"');  
             ?> 
           ...
           <div class="form-group">
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
               <input id="home_district"    class="form-control" type="text" value="<?php echo $staff_info['home_district']; ?>"  name="home_district">
               <span class="red"><?php echo form_error('home_district'); ?></span>
             </div>
           </div>
           ...
           <div class="form-group">
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
               <input id="mobile_no"    class="form-control" type="text" value="<?php echo $staff_info['mobile']; ?>"  name="mobile">
           ...
           <div class="form-group">
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
               <input id="email"    class="form-control" type="email"  value="<?php echo $staff_info['email']; ?>" name="email" >
               <span class="red"><?php echo form_error('email'); ?></span>
             </div>
           </div>

           <div class="form-group">
             <label class="col-sm-3 control-label"><?php echo $this->lang->line('staff id.');?>*</label>
             <div class="col-sm-9 col-md-6 col-lg-6">
               <input id="employee_no"    class="form-control" type="text"  value="<?php echo $staff_info['staff_no']; ?>"  name="employee_no">
           ...
           <div class="form-group">
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
               <input id="photo"    class="form-control" type="file"  value="<?php echo $staff_info['image'] ?>"  name="photo">
         ...
         <?php foreach ($staff_education_info as $value) {
          echo"
          ...
          <div>
           ...
           <?php foreach ($staff_training_info as $value) {
