   ...
   <section class="content">
     <div class="box box-info custom_box">
       <div class="box-header">
         <h3 class="box-title"><i class="fa fa-plus-circle"></i> <?php echo $this->lang->line('add staff');?></h3>
       </div><!-- /.box-header -->
       <!-- form start -->
        
         <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url().'admin_staff/add_staff_action';?>" method="POST" >
          <div class="box-body">
           ...
           <div class="form-group">
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
             <?php 
             $academic_rank['']=$this->lang->line("designation");
           ...
           <!-- <div class="form-group">
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
             <?php 
             $administrative_rank['']=$this->lang->line("rank");
             echo form_dropdown('administrative_rank',$administrative_rank,set_value('administrative_rank'),'class="form-control" id="administrative_rank"');  
             ?>              
