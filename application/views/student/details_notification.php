				...
				<div class="box-body">					
					<div class="form-group">
						...
						<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 text-justify">
							<?php if(isset($query_data[0]['title'])) echo $query_data[0]['title']; ?>
						</div>
					</div>
					<hr/>
					<div class="form-group">
						...
						<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 text-justify">
							...
							<?php if(isset($query_data[0]['message'])) echo $query_data[0]['message']; ?>
						</div>
					</div>
					<hr/>
					<div class="form-group">
						...
						<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
							<?php if(isset($query_data[0]['type'])) echo $query_data[0]['type']; ?>
						</div>
					</div>
