<div class="navbar-custom-menu">
	<ul class="nav navbar-nav">
		<li class="dropdown messages-menu">
			<a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Query/ Complain Reply">
			...
			<ul class="dropdown-menu">
		        ...
		        if($count>0) 
		        { ?>
			    	<li class="header text-center">You have <?php echo $count2; ?> <?php echo $this->lang->line('query/ complain replies.');?></li>
					<li>
						...
						<ul class="menu">
							...
							foreach($student_query_notifications as $row) 
	              			{ ?> 
		              			<li><!-- start message -->
									<a href="<?php echo site_url().'student/details_query/'.$row['id']; ?>">									
										<h4 class="no_margin blue">
											<i class="fa fa-envelope"></i> <?php echo $this->lang->line('view reply');?>
											<small><i class="fa fa-clock-o"></i><?php echo $row['reply_at'];?></small>
										</h4>
										<p class="no_margin">
											<?php 
							                    if(strlen($row['reply_message'])>30)
							                    echo substr($row['reply_message'], 0, 30)."...";
							                    else echo $row['reply_message'];
							                 ?>
										</p>
									</a>
								</li><!-- end message -->	
				...
				<li class="footer"><a href="<?php echo site_url().'student/student_query';?>"><?php echo $this->lang->line('see all queries/ complains');?></a></li>
			</ul>
		</li>
		...
		<li class="dropdown messages-menu">
			<a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Notifications">
				...
				<span class="label label-warning">
					<?php 
			          $count=count($student_sms_email_notifications);
                	   echo $count; 
                	   $count2=$count;
			           if($count==0) $count2="no";
			        ?>
			...
			<ul class="dropdown-menu">
		        ...
		        { ?>
					...
					<li>
						...
						<ul class="menu">
							<?php 
							foreach($student_sms_email_notifications as $row) 
	              			{ ?> 
		              			<li><!-- start message -->
									<a href="<?php echo site_url().'student/details_notification/'.$row['id']; ?>">									
										<h4 class="no_margin blue">
				...
				<li class="footer"><a href="<?php echo site_url().'student/sms_history';?>"><?php echo $this->lang->line('see all notifications');?></a></li>
			</ul>
		</li>
    ...
    <?php 
      $pro_pic=base_url().'upload/student/'.$this->session->userdata('profile_pic');
