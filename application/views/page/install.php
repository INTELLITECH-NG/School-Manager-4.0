<?php 
  ...
  if(function_exists('mysqli_connect'))
    ...
    $install_allow = 0;
    $mysqli_support="<div class='alert alert-danger'><i class='fa fa-times-circle'></i> <b>mysqli support : </b>Error. MySqli Support is not available. Please enable MySqli Support.</div>";
  }
?>
    ...
    <div class="account-wall" id='recovery_form' style='text-align:left; padding:0 15px;'> 
      <form class="form-horizontal" action="<?php echo site_url().'home/installation_action';?>" method="POST">
        ...
        <div class="form-group">
           ...
           <input type="email" value="<?php echo set_value('institute_email'); ?>" name="institute_email" required class="form-control col-xs-12"  placeholder="Institute Email *">          
        </div>
        <div class="form-group">
