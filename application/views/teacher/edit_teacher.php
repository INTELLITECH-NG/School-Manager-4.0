   ...
   <section class="content">
     <div class="box box-info custom_box">
       <div class="box-header">
         <h3 class="box-title"><i class="fa fa-plus-circle"></i> <?php echo $this->lang->line("edit profile");?></h3>
       </div><!-- /.box-header -->
       <!-- form start -->
        
         <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url().'teacher/edit_teacher_action';?>" method="POST" >
          <div class="box-body"> 
            ...
            <div class="form-group">
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
               <input  id="name"  class="form-control" type="text" value="<?php echo $teacher_info['teacher_name'];?>"   name="name">
           ...
           <div class="form-group" >
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
            <label class="radio-inline"><input type="radio" value='Male' name="gender" <?php if($teacher_info['gender']=='Male') echo "checked";?>>Male</label>
            <label class="radio-inline"><input type="radio" value="Female" name="gender" <?php if($teacher_info['gender']=='Female') echo "checked";?>>Female</label>
           ...
           <div class="form-group">
             <label class="col-sm-3 control-label"><?php echo $this->lang->line('administrative rank');?> </label>
             <div class="col-sm-9 col-md-6 col-lg-6">
             <?php 
             $administrative_rank['']=$this->lang->line('administrative rank');
           ...
           <div class="form-group">
             ...
             <div class="col-sm-9 col-md-6 col-lg-6">
             <?php 
             $district['']= $this->lang->line('home district');
         ...
         <div class="box-footer">
            <div class="form-group">
             <div class="col-sm-12 text-center">
              ...
              <input type="button" class="btn btn-default btn-lg" value=<?php echo $this->lang->line("cancel");?> onclick='goBack("teacher/index",1)'/>  
             </div>
           </div>                  
         </div><!-- /.box-footer -->         
         </div><!-- /.box-info -->   
